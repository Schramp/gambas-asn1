...
///        naming interface (#216) is genuinely language-agnostic and not
///        secretly C++-shaped.
///
...
///
/// No `emit_*` methods yet — `Backend` doesn't have any (#225 adds them
/// incrementally, pairwise with CppBackend; see gambas-asn1#217/#225).
