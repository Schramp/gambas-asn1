...
int main() {
    printf("\n── Alt2 (2-alternative CHOICE) BER ──────────────────────────────\n");
    {
        ...
        auto enc = ber_enc(v, HasAlt2::asn_DEF); HasAlt2 got{};
        check("Alt2::num=42 BER rt",
              ber_dec(enc, got, HasAlt2::asn_DEF)
    ...
    printf("\n── Alt2 XER ──────────────────────────────────────────────────────\n");
    {
        ...
        auto xml = xer_enc(v, HasAlt2::asn_DEF); HasAlt2 got{};
        check("Alt2::num=7 XER rt",
              xer_dec(xml, got, HasAlt2::asn_DEF)
    ...
    }
    {
        ...
        auto xml = xer_enc(v, HasAlt2::asn_DEF);
    ...
    printf("\n── Alt4 (4-alternative CHOICE) BER ──────────────────────────────\n");
    {
        ...
        auto enc = ber_enc(v, HasAlt4::asn_DEF); HasAlt4 got{};
        check("Alt4::num=100 BER rt",
              ber_dec(enc, got, HasAlt4::asn_DEF)
    ...
    }
    {
        ...
        auto enc = ber_enc(v, HasAlt4::asn_DEF); HasAlt4 got{};
        bool raw_ok = ber_dec(enc, got, HasAlt4::asn_DEF)
    ...
    printf("\n── Alt4 XER ──────────────────────────────────────────────────────\n");
    {
        ...
        auto xml = xer_enc(v, HasAlt4::asn_DEF); HasAlt4 got{};
        check("Alt4::str XER rt",
              xer_dec(xml, got, HasAlt4::asn_DEF)
