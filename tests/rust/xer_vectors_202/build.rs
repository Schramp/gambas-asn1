// Pulls every compiler-generated .rs file for 202-XIOTCertificate-OK.asn1
// (Certificate.rs and its component types + lib.rs) from the directory
// named by ASN1CPP_RUST_XV202_GEN_DIR into OUT_DIR.
//
// Identical strategy to tests/rust/ber_vectors_62/build.rs: reads the
...
fn main() {
    let gen_dir = env::var("ASN1CPP_RUST_XV202_GEN_DIR").expect(
        "ASN1CPP_RUST_XV202_GEN_DIR must be set to the directory containing the compiler-generated \
         Certificate.rs and friends + lib.rs (see tests/CMakeLists.txt's rust_xer_vectors_202 ENVIRONMENT property)",
    );
    ...
    println!("cargo:rerun-if-env-changed=ASN1CPP_RUST_XV202_GEN_DIR");
