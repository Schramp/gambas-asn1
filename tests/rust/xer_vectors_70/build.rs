// Pulls every compiler-generated .rs file for 70-xer-test-OK.asn1 (PDU.rs
// and its 15 CHOICE-alternative types + lib.rs) from the directory named by
// ASN1CPP_RUST_XV70_GEN_DIR into OUT_DIR — gambas-asn1#324.
//
...
fn main() {
    let gen_dir = env::var("ASN1CPP_RUST_XV70_GEN_DIR").expect(
        "ASN1CPP_RUST_XV70_GEN_DIR must be set to the directory containing the compiler-generated \
         PDU.rs and friends + lib.rs (see tests/CMakeLists.txt's rust_xer_vectors_70 ENVIRONMENT property)",
    );
    ...
    println!("cargo:rerun-if-env-changed=ASN1CPP_RUST_XV70_GEN_DIR");
