// Pulls every compiler-generated .rs file for 203-automatic-tags-OK.asn1
// (RecChoice.rs and its sibling types + lib.rs) from the directory named
// by ASN1CPP_RUST_SRC203_GEN_DIR into OUT_DIR.
//
...
fn main() {
    let gen_dir = env::var("ASN1CPP_RUST_SRC203_GEN_DIR").expect(
        "ASN1CPP_RUST_SRC203_GEN_DIR must be set to the directory containing the compiler-generated \
         RecChoice.rs and friends + lib.rs (see tests/CMakeLists.txt's rust_self_ref_choice_203 ENVIRONMENT property)",
    );
    ...
    println!("cargo:rerun-if-env-changed=ASN1CPP_RUST_SRC203_GEN_DIR");
