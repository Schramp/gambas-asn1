...
inline constexpr TypeDescriptor asn_DEF_Null         = { "NULL",         Tag::universal( 5, false), nullptr, nullptr, nullptr, nullptr };
inline constexpr TypeDescriptor asn_DEF_Real         = { "REAL",         Tag::universal( 9, false), nullptr, nullptr, nullptr, nullptr };
inline constexpr TypeDescriptor asn_DEF_BitString    = { "BIT STRING",   Tag::universal( 3, false), nullptr, nullptr, nullptr, nullptr };
inline constexpr TypeDescriptor asn_DEF_Oid          = { "OBJECT IDENTIFIER", Tag::universal( 6, false), nullptr, nullptr, nullptr, nullptr };
inline constexpr TypeDescriptor asn_DEF_RelativeOid  = { "RELATIVE-OID", Tag::universal(13, false), nullptr, nullptr, nullptr, nullptr };
inline constexpr TypeDescriptor asn_DEF_UtcTime      = { "UTCTime",       Tag::universal(23, false), nullptr, nullptr, nullptr, nullptr };
inline constexpr TypeDescriptor asn_DEF_GeneralizedTime = { "GeneralizedTime", Tag::universal(24, false), nullptr, nullptr, nullptr, nullptr };
...
inline constexpr TypeDescriptor asn_DEF_NumericString  = { "NumericString",  Tag::universal(18, false), nullptr, nullptr, nullptr, nullptr };
inline constexpr TypeDescriptor asn_DEF_PrintableString= { "PrintableString",Tag::universal(19, false), nullptr, nullptr, nullptr, nullptr };
inline constexpr TypeDescriptor asn_DEF_T61String      = { "T61String",      Tag::universal(20, false), nullptr, nullptr, nullptr, nullptr };
inline constexpr TypeDescriptor asn_DEF_VisibleString  = { "VisibleString",  Tag::universal(26, false), nullptr, nullptr, nullptr, nullptr };
inline constexpr TypeDescriptor asn_DEF_GeneralString  = { "GeneralString",  Tag::universal(27, false), nullptr, nullptr, nullptr, nullptr };
inline constexpr TypeDescriptor asn_DEF_GraphicString  = { "GraphicString",  Tag::universal(25, false), nullptr, nullptr, nullptr, nullptr };
inline constexpr TypeDescriptor asn_DEF_UniversalString= { "UniversalString",Tag::universal(28, false), nullptr, nullptr, nullptr, nullptr };
inline constexpr TypeDescriptor asn_DEF_BmpString      = { "BMPString",      Tag::universal(30, false), nullptr, nullptr, nullptr, nullptr };
inline constexpr TypeDescriptor asn_DEF_VideotexString = { "VideotexString", Tag::universal(21, false), nullptr, nullptr, nullptr, nullptr };
inline constexpr TypeDescriptor asn_DEF_ObjectDescriptor={ "ObjectDescriptor",Tag::universal(7, false), nullptr, nullptr, nullptr, nullptr };
